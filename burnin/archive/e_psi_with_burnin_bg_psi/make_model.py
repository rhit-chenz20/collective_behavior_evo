...
phenotype[group.index] = (1-psis[group.index]) * as + psis[group.index] * best_fit_a;
"""
...
phenotype[group.index] = (1-psis[group.index]) * as + psis[group.index] * extreme_a;
"""
...
adj_fitness = abs_fitness / (1 + psis * inds.tagF);
"""
