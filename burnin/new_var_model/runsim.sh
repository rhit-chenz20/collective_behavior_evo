        ...
        for sz in 40 80 120; do
            ...
            for beta in 0.0 0.05 0.3 0.5 0.7 0.9 1.0; do
                ...
                bin/slim5.0 -d psi=-100 \
                    ...
                    -d n=$n \
                    -d shift_size=$sz \
                    -d "phenotype_fn='../../data/${dir_name}/phenotype/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "genotype_fn='../../data/${dir_name}/genotype/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "fre_output='../../data/${dir_name}/data/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "ind_fn='../../data/${dir_name}/ind/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "mut_fn='../../data/${dir_name}/mut/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "vars_fn='../../data/${dir_name}/vars/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.tsv'" \
                    -d "pop_output='../../data/${dir_name}/pop/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.pop'" \
                    var.slim &> ../../data/${dir_name}/log/n_${n}_beta_${beta}_sz_${sz}_reg_var_${rep}.txt &
