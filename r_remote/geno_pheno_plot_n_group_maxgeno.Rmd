...
base_data_folder <- "../data/n_group_maxgeno_data"
base_plot_folder <- "../r_plots/n_group_maxgeno"
...
for (n_val in sort(unique(genotype_df$n))) {
  df_n <- subset(genotype_df, generation == 10099 & n == n_val)
...
for (n_val in sort(unique(phenotype_df$n))) {
  df_n <- subset(phenotype_df, generation == 10099 & n == n_val)
