...
target_beta <- c(0.0, 0.05, 0.3, 0.5, 0.7, 0.9, 1.0)
...
plot_decay_heatmap_per_shift <- function(decay_tbl,
  ...
  # keep finite metric
  df <- decay_tbl[is.finite(decay_tbl[[metric]]) & decay_tbl$k < 10 & decay_tbl$n > 2, , drop = FALSE]
...
plot_decay_heatmap_per_shift(decay_tbl, metric = "k", out_subfolder = "decay_k_heatmaps_exc")
```
