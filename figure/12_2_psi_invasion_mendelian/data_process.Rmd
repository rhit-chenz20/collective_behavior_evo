...
setwd(wd_path)
base_data_folders <- c("../../data/psi_invasion_mendelian")
base_plot_folder <- "../plots/12_2/psi_invasion_mendelian"
rds_data_folder <- "../r_data/psi_invasion_mendelian"
...
```{r}
saveRDS(genotype_df, file = "../r_data/psi_invasion/genotypes.rds")
```
...
```{r}
saveRDS(phenotype_df, file = "../r_data/psi_invasion/phenotypes.rds")
```
...
```{r}
saveRDS(psis_betas_df, file = "../r_data/psi_invasion/psis.rds")
```
...
```{r}
saveRDS(fitness_df, file = "../r_data/psi_invasion/fitnesses.rds")
```
