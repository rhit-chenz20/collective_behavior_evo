...
setwd(wd_path)
base_plot_folder <- "../plots/1_23/fluctuating_env"
...
# load genotype data
```{r}
geno_df <- readRDS("../r_data/fluctuate_env_constant_psi/genotypes_gap100.rds")
# pheno_df <- readRDS("../r_data/fluctuate_env_constant_psi/phenotypes_gap100.rds")
```
