...
gen_seq = seq(10000, 10000, by = 10)
single_panel <- TRUE
include_pre_selection <- TRUE # whether to include pre-selection distribution in the plot
```
...
```{r setup, include=FALSE}
param_val <- c(0.0, 0.01, 0.03, 0.05, 0.07， 0.1, 0.3, 0.5, 0.7, 0.9, 1.0) # all beta values to plot for inverse-variance model
...
include_pre_selection <- TRUE
num_bins <- 100
gen_seq = c(9999, seq(10010, 10030, by = 10))
```
